...
## Installation
```
go get github.com/cythical/gomedia
```


## H264/H265/AAC/VP8/OPUS/MP3
 [USAGE](https://github.com/cythical/gomedia/blob/main/go-codec/README.md)
...
## rtmp
  ...
  [USAGE](https://github.com/cythical/gomedia/blob/main/go-rtmp/README.md)
